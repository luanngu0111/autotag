...
public class IConstants {
	...
	public static String HEADER_TRADE = "M_NB";
	public static String HEADER_FAMILY = "M_TRN_FMLY";
	public static String HEADER_GROUP = "M_TRN_GRP";
	public static String HEADER_TYPE = "M_TRN_TYPE";
	public static String HEADER_CURR = "M_TP_FXBASE";
	public static String HEADER_KEY_VAL = "KeyValue";
	public static String EXPORT_EXCEL_FILE = "export/ExportTestR077.xlsx";
